...
#### Rehab Cost Estimator
  ...
  Handling variable image quality and angles from real estate listings
  Extracting structured data from unstructured vision model outputs
  Calibrating AI confidence scores to real-world accuracy
  Dealing with incomplete information (not all property areas photographed)
